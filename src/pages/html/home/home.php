...
<body>
    ...
    <!-- jQuery -->
    <script src="src/pages/html/home/assets/js/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="src/pages/html/home/assets/js/popper.js"></script>
    <script src="src/pages/html/home/assets/js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="src/pages/html/home/assets/js/scrollreveal.min.js"></script>
    <script src="src/pages/html/home/assets/js/waypoints.min.js"></script>
    <script src="src/pages/html/home/assets/js/jquery.counterup.min.js"></script>
    <script src="src/pages/html/home/assets/js/imgfix.min.js"></script>

    <!-- Global Init -->
    <script src="src/pages/html/home/assets/js/custom.js"></script>
